...
<body>
<P><?php echo $_SESSION["name"]; ?>，您好！请在下拉列表中选择您取消主动停机的用户号码：</P>
<form action="customer_cancelUserStop2.php" name="form_cancelUserStopWindow"	method="post" onSubmit="return checkPhoneNumNotNull()">
	<!--<div class="item">手机号码：
