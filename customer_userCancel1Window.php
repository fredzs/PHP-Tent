...
<body>
<P><?php echo $_SESSION["name"]; ?>，您好！请在下拉列表中选择您办理主动撤机的用户号码：</P>
<form action="customer_userCancel2.php" name="form_userCancel"	method="post" onSubmit="return checkPhoneNumNotNull()">
	<!--<div class="item">手机号码：
